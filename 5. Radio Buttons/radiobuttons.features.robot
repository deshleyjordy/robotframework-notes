...
...              So this keyword actually never works?
...
*** Test Cases ***
Scenario: The user makes a choice by radio button with an id
    Given The user clicks on the option 'Radio with id'
    Then The option 'Radio with id' is selected

Scenario: The user makes a choice by radio button with a value
    Given The user clicks on the option 'Radio6'
    Then The option 'Radio6' is selected

Scenario: The user clicks for the option 'Radio5' by id
